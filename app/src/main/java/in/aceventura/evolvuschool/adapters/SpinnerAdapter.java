...
import in.aceventura.evolvuschool.DataObject;
import in.aceventura.evolvuschool.R;

/**
 * Created by Vinod Patil on 29-08-2017.
 */
...
public class SpinnerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        spinnerHolder.spinnerItemList.setText(listData.get(position).getBookCategory());
        return convertView;
    }
    class ViewHolder{
