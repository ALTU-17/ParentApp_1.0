package in.aceventura.evolvuschool.bottombar;
...
import in.aceventura.evolvuschool.adapters.CalendarEventsDecorator;
import in.aceventura.evolvuschool.adapters.Calendar_EventsWishAdapter;
import in.aceventura.evolvuschool.models.CalendarModel;
...
public class MyCalendar extends AppCompatActivity implements OnDateSelectedListener, OnMonthChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            class_id = SharedPrefManager.getInstance(MyCalendar.this).getClassId();
...
//todo NO Delate below below code in comment section it add event google calender need letter-
      /*  try {
            ...
            Log.e("Calender", "class_id=>" + SharedPrefManager.getInstance(MyCalendar.this).getChildClass() + "class_id fbn=" + class_id);
            ...
            url = newUrl + "get_all_published_events";
                ...
                bottomBar.setOnTabSelectListener(new OnTabSelectListener() {
                    ...
                    public void onTabSelected(@IdRes int tabId) {
                        if (tabId == R.id.tab_dashboard) {
                            //
                            Intent intent = new Intent(MyCalendar.this, ParentDashboard.class);
                     ...
                     /*   Intent intent = new Intent(MyCalendar.this, MyCalendar.class);
                        ...
                        if (tabId == R.id.tab_profile) {
                            // The tab with id R.id.tab_favorites was selected,
                            // change your content accordingly.
                            Intent intent = new Intent(MyCalendar.this, ParentProfile.class);
                            intent.putExtra("class_id", class_id);
                            intent.putExtra("section_id", section_id);
                            startActivity(intent);
                        }
        ...
        try {
            ...
            StringRequest request = new StringRequest(Request.Method.POST, rurl, new Response.Listener<String>() {
                ...
                protected Map<String, String> getParams() {
                    ...
                    params.put("academic_yr", SharedPrefManager.getInstance(MyCalendar.this).getAcademicYear());//name//"SACS"
    ...
    public void onBackPressed() {
        Intent i = new Intent(MyCalendar.this, ParentDashboard.class);
